...
namespace Shared.Dtos
{
    ...
    public record MultiDayConferenceDto(int Id, DateTimeOffset Date, string Name, EventType EventType, 
        string Venue, int Capacity, int Sold, int BadgeCosts, int CateringCosts, int NumberOfDays)
